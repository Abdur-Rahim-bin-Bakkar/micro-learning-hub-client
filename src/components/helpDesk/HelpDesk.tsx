    ...
    return (
        <section className="min-h-screen bg-slate-50 dark:bg-[#0B1120] py-10">
            <div className="mx-auto max-w-7xl px-5">
                ...
                <div className="mx-auto mb-8 max-w-3xl overflow-hidden rounded-3xl border border-blue-200 bg-gradient-to-br from-cyan-500 to-blue-600 p-5 sm:p-6 md:p-7 text-white shadow-2xl">
